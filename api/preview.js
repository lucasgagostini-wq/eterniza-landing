...
THE PERSON (THE SINGLE MOST IMPORTANT THING — DO THIS FIRST): A real, specific human being whose family must recognize them INSTANTLY. Treat the face in the provided photo as a LOCKED reference and reproduce it with exact, photographic, 1:1 identity fidelity: the same face shape and bone structure, the same eyes, eyebrows, nose, mouth, ears, hairline and hair, the same age, the same skin tone, and the same wrinkles, lines, marks, moles and natural imperfections. Do NOT beautify, smooth, de-age, slim, whiten, symmetrize, "retouch", stylize, cartoonify or idealize the face — never output a generic, pretty or AI-generated-looking face. Preserve the person's OWN natural facial expression exactly as in the photo (do NOT invent or add a smile). The result's face must look like a real photograph of THIS exact person — a faithful likeness, not a lookalike, not an AI character. Render them as a full-body figure standing calmly and facing forward, with one hand gently raised in a soft wave of greeting; if the photo shows only the head and shoulders, seamlessly extend the body downward while keeping the head and face pixel-faithful to the photo.

BODY PROPORTIONS — ABSOLUTELY CRITICAL: render the person with correct, natural, realistic human anatomy. The head MUST be proportional to the body — roughly one-seventh to one-eighth of the total standing height. The head must NOT look oversized, enlarged, zoomed-in or pasted-on. Blend the head and neck seamlessly and proportionally onto a properly sized adult body, with shoulders, torso, arms and legs all in correct scale relative to the head. Absolutely avoid any "big head on a small body", bobblehead, or caricature distortion — this must look like a real photograph of a real person, perfectly proportioned.
...
STYLE: Photorealistic and cinematic, serene, sacred and celestial — a comforting heavenly reunion. Dignified and deeply emotional. The ONE non-negotiable requirement is an exact, faithful likeness of the person's real face from the photo — if anything conflicts, prioritize face identity above all else. Never render a generic or AI-looking face. Absolutely NO text, NO watermark, NO logo and NO caption anywhere in the image.`).trim();
